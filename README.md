[![pipeline status](https://gitlab.com/mr-coding-challenge/allume/badges/0.2.17/pipeline.svg)](https://gitlab.com/mr-coding-challenge/allume/commits/0.2.17)
...
View [GUI](https://allume.marvinroman.me/).

### Logs

There is a small GUI that will display the logs produced by the API that logs all the test transactions. The request hash is in the title of accordings so that you can match Request & Response. View [logs](https://allume.marvinroman.me/logs).
